@ Test to check the behavior of entering abort mode
...
Context2:	.word 0xFFFF0000, 0x11221122, 0x12345678, 0xa, 0xb, 0xc, 0xd, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0, 0, 0
...
_start:
	...
	@ Exit ABT Mode and enter Supervisor mode
	mrs r0,CPSR
	bic r0,r0,#0x1F
	orr r0,r0,#0x13
	msr CPSR,r0
	...
	@ Re-enter ABT Mode for checking r0
	mrs r1,CPSR
	bic r1,r1,#0x1F
	orr r1,r1,#0x17
	msr CPSR,r1
