@ Test to check the behavior of leaving fast interrupt mode
...
@ Once you are in supervisor mode check register R0-7 maintain their values, register R8-12, registers SP, LR and CPSR have different values that the ones stored in the var Context, and that SPSR is equal to the stored CPSR.
...
.data
.align 2
Context:	.word 0x51515150, 0x25252221, 0xF5823952, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8, 0xa9, 0xaA, 0xaB, 0xaC, 0xa0, 0xa0, 0x0
Error_Msg:	.asciz "There has been an error on the reg: "
Success_Msg:	.asciz "Test ended successfully\n"

Error_Reg: .ascii "Rg00 Rg01 Rg02 Rg03 Rg04 Rg05 Rg06 Rg07 Rg08 Rg09 Rg10 Rg11 Rg12 RgSP RgLR CPSR SPSR"
...
_start:
	...
	@ Exit FIQ Mode ad enter Supervisor mode
	mrs r0,CPSR
	bic r0,r0,#0x1F
	orr r0,r0,#0x13
	msr CPSR,r0
	...
	@ Re-enter FIQ Mode for checking r0
	mrs r0,CPSR
	bic r0,r0,#0x1F
	orr r0,r0,#0x11
	msr CPSR,r0
